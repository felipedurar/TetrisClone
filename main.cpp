...
int main(int argc, char* args[])
{
    ...
    GenerateTmpMatrix(GetNewPieceIndex());
    // Start Music
...
string GetCurrentPath()
{
    ...
    size_t pos = string(cp).find_last_of("\\/");
    return string(cp).substr(0, pos);
}
...
bool LoadFiles()
{
    ...
    SPRITE_BORDER = LoadSurfaceFromFile((dir + "borda.png").c_str());
    SPRITE_BLUE = LoadSurfaceFromFile((dir + "p_blue.png").c_str());
    SPRITE_CYAN = LoadSurfaceFromFile((dir + "p_cyan.png").c_str());
    SPRITE_GRAY = LoadSurfaceFromFile((dir + "p_gray.png").c_str());
    SPRITE_GREEN = LoadSurfaceFromFile((dir + "p_green.png").c_str());
    SPRITE_ORANGE = LoadSurfaceFromFile((dir + "p_orange.png").c_str());
    SPRITE_RED = LoadSurfaceFromFile((dir + "p_red.png").c_str());
    SPRITE_YELLOW = LoadSurfaceFromFile((dir + "p_yellow.png").c_str());

    // LOGO, TextPiece, StartImage, GameOver
    LOGO = LoadSurfaceFromFile((dir + "logo.png").c_str());
    TextPiece = LoadSurfaceFromFile((dir + "cp.png").c_str());
    StartImage = LoadSurfaceFromFile((dir + "tetris_logo.jpg").c_str());
    GameOver = LoadSurfaceFromFile((dir + "gameover.png").c_str());

    // Load Level Images
    L1 = LoadSurfaceFromFile((dir + "l1.png").c_str());
    L2 = LoadSurfaceFromFile((dir + "l2.png").c_str());
    L3 = LoadSurfaceFromFile((dir + "l3.png").c_str());
    L4 = LoadSurfaceFromFile((dir + "l4.png").c_str());
    L5 = LoadSurfaceFromFile((dir + "l5.png").c_str());

    // Load Music
    TetrisMusic = Mix_LoadMUS((dir + "Tetris.mp3").c_str());
